...
#ifdef SIGUSR1
static const int signums[jdkcat::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM, SIGUSR1 };
#else
static const int signums[jdkcat::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM };
#endif


jdkcat::Signals::Signals(ISignalListener *listener)
    : m_listener(listener)
{
#   ifndef jdkcat_OS_WIN
...
void jdkcat::Signals::onSignal(uv_signal_t *handle, int signum)
{
    switch (signum)
    {
    case SIGHUP:
