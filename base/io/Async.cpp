...
// since 2019.05.16, Version 1.29.0 (Stable) https://github.com/jdkcat/jdkcat/pull/1889
...
jdkcat::Async::Async(Callback callback) : d_ptr(new AsyncPrivate())
{
...
jdkcat::Async::Async(IAsyncListener *listener) : d_ptr(new AsyncPrivate())
{
