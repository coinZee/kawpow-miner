...
bool jdkcat::Json::get(const char *fileName, rapidjson::Document &doc)
{
    OPEN_IFS(fileName)
...
bool jdkcat::Json::save(const char *fileName, const rapidjson::Document &doc)
{
    using namespace rapidjson;
...
#   ifdef jdkcat_JSON_SINGLE_LINE_ARRAY
...
bool jdkcat::Json::convertOffset(const char *fileName, size_t offset, size_t &line, size_t &pos, std::vector<std::string> &s)
{
    OPEN_IFS(fileName)
