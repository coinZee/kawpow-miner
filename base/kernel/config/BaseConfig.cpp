...
bool jdkcat::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
void jdkcat::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
#   if defined(jdkcat_FEATURE_HWLOC)
...
void jdkcat::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
