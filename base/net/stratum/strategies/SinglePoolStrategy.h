...
#ifndef jdkcat_SINGLEPOOLSTRATEGY_H
#define jdkcat_SINGLEPOOLSTRATEGY_H
...
{
public:
    jdkcat_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* jdkcat_SINGLEPOOLSTRATEGY_H */
