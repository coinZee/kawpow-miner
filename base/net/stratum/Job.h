...
{
public:
    // Max blob size is 84 (75 fixed + 9 variable), aligned to 96. https://github.com/jdkcat/jdkcat/issues/1 Thanks fireice-uk.
    // SECOR increase requirements for blob size: https://github.com/jdkcat/jdkcat/issues/913
