...
jdkcat::DnsUvBackend::DnsUvBackend()
{
...
std::shared_ptr<jdkcat::DnsRequest> jdkcat::DnsUvBackend::resolve(const String &host, IDnsListener *listener, uint64_t ttl)
{
...
bool jdkcat::DnsUvBackend::resolve(const String &host)
{
...
void jdkcat::DnsUvBackend::onResolved(int status, addrinfo *res)
{
...
void jdkcat::DnsUvBackend::onResolved(uv_getaddrinfo_t *req, int status, addrinfo *res)
{
