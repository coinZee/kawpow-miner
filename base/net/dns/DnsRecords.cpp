...
const jdkcat::DnsRecord &jdkcat::DnsRecords::get(DnsRecord::Type prefered) const
{
...
size_t jdkcat::DnsRecords::count(DnsRecord::Type type) const
{
    if (type == DnsRecord::A) {
        return m_ipv4.size();
    }
...
void jdkcat::DnsRecords::parse(addrinfo *res)
{
    clear();
