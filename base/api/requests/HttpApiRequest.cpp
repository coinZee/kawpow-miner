...
jdkcat::HttpApiRequest::HttpApiRequest(const HttpData &req, bool restricted) :
...
bool jdkcat::HttpApiRequest::accept()
{
...
const rapidjson::Value &jdkcat::HttpApiRequest::json() const
{
    if (type() == REQ_JSON_RPC) {
...
jdkcat::IApiRequest::Method jdkcat::HttpApiRequest::method() const
{
    return static_cast<IApiRequest::Method>(m_req.method);
}


void jdkcat::HttpApiRequest::done(int status)
{
...
void jdkcat::HttpApiRequest::setRpcError(int code, const char *message)
{
    using namespace rapidjson;
    auto &allocator = doc().GetAllocator();
...
void jdkcat::HttpApiRequest::setRpcResult(rapidjson::Value &result)
{
    rpcDone(kResult, result);
}


void jdkcat::HttpApiRequest::rpcDone(const char *key, rapidjson::Value &value)
{
    ApiRequest::done(0);
