...
void jdkcat::Api::request(const HttpData &req)
{
...
void jdkcat::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void jdkcat::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
void jdkcat::Api::genId(const String &id)
{
...
void jdkcat::Api::genWorkerId(const String &id)
{
