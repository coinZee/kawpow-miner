...
bool jdkcat::WalletAddress::decode(const char *address, size_t size)
{
    uint64_t tf_tag = 0;
...
bool jdkcat::WalletAddress::decode(const rapidjson::Value &address)
{
    return address.IsString() && decode(address.GetString(), address.GetStringLength());
}


const char *jdkcat::WalletAddress::netName() const
{
...
const char *jdkcat::WalletAddress::typeName() const
{
...
rapidjson::Value jdkcat::WalletAddress::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value jdkcat::WalletAddress::toAPI(rapidjson::Document &doc) const
{
    using namespace rapidjson;
...
const jdkcat::WalletAddress::TagInfo &jdkcat::WalletAddress::tagInfo(uint64_t tag)
{
