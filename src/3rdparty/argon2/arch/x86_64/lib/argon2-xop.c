...
void jdkcat_ar2_fill_segment_xop(const argon2_instance_t *instance, argon2_position_t position)
{
    fill_segment_128(instance, position);
}

extern int cpu_flags_has_xop(void);
int jdkcat_ar2_check_xop(void) { return cpu_flags_has_xop(); }

#else

void jdkcat_ar2_fill_segment_xop(const argon2_instance_t *instance, argon2_position_t position) {}
int jdkcat_ar2_check_xop(void) { return 0; }
