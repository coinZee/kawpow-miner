...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       jdkcat_ar2_check_sse2,     jdkcat_ar2_fill_segment_sse2 },
        { "SSSE3",      jdkcat_ar2_check_ssse3,    jdkcat_ar2_fill_segment_ssse3 },
        { "XOP",        jdkcat_ar2_check_xop,      jdkcat_ar2_fill_segment_xop },
        { "AVX2",       jdkcat_ar2_check_avx2,     jdkcat_ar2_fill_segment_avx2 },
        { "AVX-512F",   jdkcat_ar2_check_avx512f,  jdkcat_ar2_fill_segment_avx512f },
    };
